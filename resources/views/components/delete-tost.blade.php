    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body modal-alert">
                ...
                <div class="modal-text">@lang('Are sure of the deleting process ?')</div>
            </div>
            <div class="modal-footer modal-btns">
                <div class="payment-btns text-center">
                    <button type="submit" class="btn_hover agency_banner_btn btn-bg">@lang('Yes')</button>
                    <button type="button" class="btn_hover agency_banner_btn btn-bg btn-bg3" data-dismiss="modal">@lang('Cancel')</button>
                </div>
            </div>
        </div>
    </div>
