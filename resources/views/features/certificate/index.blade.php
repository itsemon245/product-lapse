...
@section('main')
    <x-feature.index>
        <x-slot:breadcrumb>
            <x-breadcrumb :list="[['label' => @__('feature/certificate.title'), 'route' => route('certificate.index')]]" />
        </x-slot:breadcrumb>
                ...
                <div class="sign_info">
                    <div class="login_info form-layout">
                        ...
                        <div class="d-flex justify-content-center align-items-center text-center certificate-btns">
                            <x-button type="link" href="{{ route('certificate.status') }}"
                                class="btn_hover agency_banner_btn btn-bg">@__('feature/certificate.get-certificate')</x-button>
