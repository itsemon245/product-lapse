...
@section('main')
    <x-feature.create>
        ...
        @if ($certificate == !null)
            @if ($certificate->approved_id == !null)
            <div class="certificate-1 mx-auto my-auto" style="display: flex; justify-content: center; align-items: center;" ><img src="{{ asset('img/logo.png') }}"></div> 
            <div class="certificate-2" style="display: flex; justify-content: center; align-items: center;" ><img src="{{ asset('img/certificate.jpg') }}"></div>
            ...
            <div class="certificate-text">
                <p style="display: flex; justify-content: center; align-items: center;"> <span>Waiting for Admin Approval!</span> </p>
            </div>
            <div class="d-flex justify-content-center align-items-center text-center certificate-btns">
                <x-button type="link" href="{{ route('product.index') }}" class="btn_hover agency_banner_btn btn-bg">Return back</x-button>
