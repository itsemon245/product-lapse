                ...
                <form method="post" action="{{ route('deliverable.store') }}" enctype="multipart/form-data" class="login-form sign-in-form">
                    ...
                    <div class="row">
                        <div class="form-group text_box col-lg-6 col-md-6">
                            <x-input-label for="name" value="Deliverable name" />
                        ...
                        <div class="form-group text_box col-lg-6 col-md-6">
                            ...
                            <x-text-input id="items" class="block mt-1 w-full" type="text" placeholder="Deliverable items" name="items" :value="old('items')" required autofocus />
                            <x-input-error :messages="$errors->get('items')" class="mt-2" />
                        </div>
                        <div class="form-group text_box col-lg-12 col-md-6">
                            <x-input-label for="link" value="Deliverables link" />
                    ...
                    <div class="d-flex align-items-center text-center">
                        <x-btn-primary name="Add Deliverable" type="submit" />
