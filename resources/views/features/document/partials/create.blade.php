    ...
    <x-slot:from>
        ...
        <form method="POST" action="{{ route('document.store') }}" enctype="multipart/form-data"
            ...
            <div class="row">
                <div class="form-group text_box col-lg-12 col-md-12">
                    ...
                    <x-input id="name" class="block mt-1 w-full" type="text"
                        placeholder="{{ __('feature/document.placeholder.name') }}" name="name" :value="old('name')" required autofocus />
                </div>
            ...
            <div class="d-flex align-items-center text-center">
                <button type="submit" class="btn_hover agency_banner_btn btn-bg agency_banner_btn2">{{ __('feature/document.submit') }}</button>
