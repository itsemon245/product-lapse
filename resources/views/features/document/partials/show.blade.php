    ...
    <x-feature.show>
        <x-slot:breadcrumb>
            <x-breadcrumb :list="[
                ...
                ['label' => @__('feature/document.show'), 'route' => route('document.show', $document->id)],
            ]" />
        </x-slot:breadcrumb>
                ...
                <div class="blog_single mb_50">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6">
                            ...
                            <p class="f_400 mb-30 text-font">{{ $document->getSelect('type')->value->{app()->getLocale()} }}
                            </p>
                        </div>
                        <div class="col-md-12">
                            ...
                            @can('update document')
                                                        ...
                                                        <div class="extra extra2 extra3">
                                                            <div class="media post_author state-select">
                                                                <div class="media-body form-group text_box col-lg-12 col-md-12">
                                                                    <x-input type="text" :label="__('feature/document.label.version')" name="version"
                                                                        class="form-control"
                                                                        placeholder="{{ __('feature/document.placeholder.version') }}"
                                                                        :value="$document->version" required />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="col-6">
                                    <a href="{{ route('document.edit', ['document' => $document]) }}"
                                        class="button-1 btn-bg-2"><i class="ti-reload"></i>@__('feature/document.update')</a>
                                    </form>
                                </div>
                            @endcan
                            @if ($document->file)
                                <div class="col-12">
                                    <form action="{{ route('document.download', ['id' => $document->id]) }}" method="post"
