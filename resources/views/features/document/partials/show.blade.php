...
<x-feature.show>
    <x-slot:breadcrumb>
        <x-breadcrumb :list="[['label' => @__('feature/document.show'), 'route' => route('document.show', $document->id)]]" />
    </x-slot:breadcrumb>
            ...
            <div class="blog_single mb_50">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        ...
                        <p class="f_400 mb-30 text-font">{{ $document->getSelect('type')->value->{app()->getLocale()} }}</p>
                    </div>
                    <div class="col-md-12">
            ...
            <div class="blog-sidebar box-sidebar">
                <div class="widget sidebar_widget widget_recent_post mt_60">
                    ...
                    <div class="row">
                        ...
                        @if ($document->file)
                            <div class="col-12">
                                <form action="{{ route('document.download', ['id' => $document->id]) }}"
