@extends('layouts.feature.index', ['title' => 'Product Category Edit'])
@section('main')
    <div id="hx-create-package" class="sign_info">
        <form action="{{ route('product-category.store', $category->id) }}" method="POST" class="login-form sign-in-form"
            enctype="multipart/form-data">
            @csrf
            <div class="login_info">
                <h2 class=" f_600 f_size_24 t_color3 mb_40">Category Edit</h2>
                ...
                <div class="row justify-content-center">
                    <div class="form-group text_box col-lg-4 col-md-6">
                        ...
                        <x-text-input id="name_en" class="block mt-1 w-full" type="text"
                            placeholder="Enter category name" name="name_en" value="{{ $category->value->en }}" required
                            autofocus />
                ...
                <div class="row justify-content-center">
                    <div class="form-group text_box col-lg-4 col-md-6">
                        ...
                        <x-text-input id="name_ar" class="block mt-1 w-full" type="text"
                            placeholder="Enter category name" name="name_ar" value="{{ $category->value->ar }}" required
                            autofocus />
                ...
                <div class="row justify-content-center">
                    <div class="form-group text_box col-lg-4 col-md-6">
                        ...
                        <x-text-input id="price" class="block mt-1 w-full" type="text" placeholder="Enter text color"
                            name="text_color" value="{{ $category->color }}" required autofocus />
