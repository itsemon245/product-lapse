...
@section('main')
    <x-feature.edit>
        ...
        <x-slot:breadcrumb>
            <x-breadcrumb :list="[
                ['label' => @__('feature/productHistory.title'), 'route' => route('product-history.index')],
                ['label' => @__('feature/productHistory.edit'), 'route' => route('product-history.edit', $productHistory)],
            ]" />
        </x-slot:breadcrumb>
