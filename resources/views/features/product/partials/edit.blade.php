...
@section('main')
    <x-feature.edit>
        <x-slot:breadcrumb>
            <x-breadcrumb :list="[['label' => 'Product', 'route' => route('product.edit', $product)]]" />
        </x-slot:breadcrumb>
        <div class="sign_info">
                        ...
                        <div class="row">
                            <div class="form-group text_box col-lg-4 col-md-6">
                                ...
                                <x-text-input id="name" class="block mt-1 w-full" type="text"
                                    placeholder="Enter product name" name="name" :value="$product->name" required autofocus />
                            ...
                            <div class="form-group text_box col-lg-4 col-md-6">
                                <x-select-input label="Stage" id="stage" placeholder="Choose one" name="stage" required
                                    autofocus>
                            ...
                            <div class="form-group text_box col-lg-8 col-md-6">
                                <x-textarea placeholder="Write description" rows="5" cols="10" name="description"
                                    label="Description"> {{ $product->description }} </x-textarea>
                            </div>
                            <div class="form-group text_box col-lg-4 col-md-6">
                                <x-attach name='logo' />
                            </div>
