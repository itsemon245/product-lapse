@extends('layouts.feature.index', ['title' => 'New Stage'])
@section('main')
    <div id="hx-create-package" class="sign_info">
        <div class="login_info">
            <h2 class=" f_600 f_size_24 t_color3 mb_40">Add Stage</h2>
            <form action="{{ route('product-stage.store') }}" method="POST" class="login-form sign-in-form"
