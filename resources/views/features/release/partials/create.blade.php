@extends('layouts.feature.index', ['title' => @__('feature/release.add')])
@section('main')
            ...
            <form action="{{ route('report.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="form-group text_box col-lg-6 col-md-6">
                        ...
                        <x-input id="release_date" class="block mt-1 w-full" type="text"
                            placeholder="{{ __('feature/release.placeholder.date') }}" name="release_date" :value="old('release_date')" required autofocus />
                    </div>
                    <div class="form-group text_box col-lg-12 col-md-6">
                        <x-textarea label="{{ __('feature/release.label.details') }}" name="description" placeholder="{{ __('feature/release.label.details') }}" required autfocus />
