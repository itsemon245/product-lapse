                ...
                <form action="{{ route('report.store') }}" method="POST" enctype="multipart/form-data" >
                    ...
                    <div class="row">
                        <div class="form-group text_box col-lg-6 col-md-6">
                            ...
                            <x-text-input id="name" class="block mt-1 w-full" type="text" placeholder="Enter Report name" name="name" :value="old('name')" required autofocus />
                        ...
                        <div class="form-group text_box col-lg-6 col-md-6">
                            ...
                            <x-text-input id="report_date" class="block mt-1 w-full" type="text" placeholder="Enter report date" name="report_date" :value="old('report_date')" required autofocus />
