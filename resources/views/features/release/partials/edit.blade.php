...
@section('main')
    <x-feature.edit>
        <x-slot:breadcrumb>
            <x-breadcrumb :list="[['label' => 'Edit Report', 'route' => route('report.edit', $report)]]" />
        </x-slot:breadcrumb>
        <x-slot:from>
            ...
            <form action="{{ route('report.update', $report) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="form-group text_box col-lg-6 col-md-6">
                        ...
                        <x-text-input id="name" value="{{ $report->name }}" class="block mt-1 w-full" type="text"
                    ...
                    <div class="form-group text_box col-lg-6 col-md-6">
                        ...
                        <x-text-input id="report_date" value="{{ $report->report_date }}" class="block mt-1 w-full"
