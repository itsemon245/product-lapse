...
<div id="hx-create-package" class="sign_info">
    <div class="login_info">
        <h2 class=" f_600 f_size_24 t_color3 mb_40">Add package</h2>
                <form hx-post="{{ route('package.store') }}" hx-trigger="submit" hx-redirect="{{ route('package.index') }}">
                    @csrf
                    <div class="row">
                    ...
                    <div class="d-flex align-items-center text-center">
                        <x-button type="submit" hx-post="{{ route('package.store') }}" hx-trigger="click" hx-headers="{'X-CSRF-TOKEN': $('meta[name='csrf-token']').attr('content')}" hx-ext="true" > 
                            Add Package
                        </x-button>
                        <x-button > 
                            Cancle
