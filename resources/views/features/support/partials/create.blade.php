                ...
                <form method="post" action="{{ route('change.store') }}" hx-post="" class="login-form sign-in-form">
                    ...
                    <div class="row">
                        <div class="form-group text_box col-lg-6 col-md-6">
                            ...
                            <x-text-input id="title" class="block mt-1 w-full" type="text" placeholder="Enter change request title" name="title" :value="old('title')" required autofocus />
                            <x-input-error :messages="$errors->get('title')" class="mt-2" />
                        </div>
                        <div class="form-group text_box col-lg-6 col-md-6">
                            <x-select-input label="Classification" id="classification"  placeholder="Choose one" name="classification" required autofocus> 
                        ...
                        <div class="form-group text_box col-lg-6 col-md-6">
                            <x-select-input label="Priority" id="priority"  placeholder="Choose one" name="priority" required autofocus> 
                                <option value="Free">Free</option>
                                <option value="Basic">Basic</option>
                                <option value="Golden">Golden</option>
                                <option value="Dimond">Dimond</option>
                        ...
                        <div class="form-group text_box col-lg-6 col-md-6">
                            <x-select-input label="Status" id="status"  placeholder="Choose one" name="status" required autofocus> 
                                <option value="Free">Free</option>
                                <option value="Basic">Basic</option>
                                <option value="Golden">Golden</option>
                                <option value="Dimond">Dimond</option>
                        ...
                        <div class="form-group text_box col-lg-6 col-md-6">
                            ...
                            <x-text-input id="required_completion_date" class="block mt-1 w-full" type="text" placeholder="dd/mm/yyyy (Exp:13/03/2024)" name="required_completion_date" :value="old('required_completion_date')" required autofocus />
