                ...
                <div class="row">
                    ...
                    <div class="form-group text_box col-lg-12 col-md-12">
                        ...
                        <textarea name="details" id="message" cols="30" rows="10"
                            placeholder="{{ __('feature/task.label.details') }}">{{ $task->details }}</textarea>
                        @error('details')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group text_box col-lg-12 col-md-12">
                        ...
                        <textarea name="steps" id="message" cols="30" rows="10"
                            placeholder="{{ __('feature/task.placeholder.steps') }}">{{ $task->steps }}</textarea>
                        @error('steps')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group text_box col-lg-6 col-md-6">
                        ...
                        <x-input type="text" placeholder="{{ __('feature/task.placeholder.administrator') }}"
                            name="administrator" value="{{ $task->administrator }}">
                            @error('administrator')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                    </div>
