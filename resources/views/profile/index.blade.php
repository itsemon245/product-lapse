                ...
                <div class="row">
                    <div class="col-md-5 col-sm-3">
                        <div class="details_img" >
                            <img class="rounded-circle" style="height: 20rem; width:20rem;" src="{{ $user->image->url ?? asset('img/profile1.png') }}" alt="">
                        </div>
                    </div>
                    <div class="col-md-7 col-sm-9">
                        <div class="details_info details_info2">
                            ...
                            <div class="btn_info d-flex">
                                <x-button type="link" href="{{ route('profile.edit') }}" class="btn_hover agency_banner_btn btn-bg">@__('profile.profile.edit')</x-button>
                            </div>
                        </div>
                    </div>
                </div>
