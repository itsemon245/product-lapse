<section>
    ...
    <form action="{{ route('profile.update', auth()->id()) }}" method="POST" enctype="multipart/form-data" class="mt-6 space-y-6">
        @csrf
        @method('PATCH')
        ...
        <div class="row">
            <div class="col-md-4 justify-self-center">
                <div class="row justify-content-center align-items-center gap-2">
                    <label class="col-sm-12" style="max-width: 320px" for="imagefile">
                        ...
                        <div class="relative">
                            <img loading="lazy" class="rounded-circle" style="height: 18rem; width:18rem;" class="border border-5 border-primary" id="liveImage"
                                src="{{ $user->image->url ?? asset('img/avatar-1577909_1280.webp') }}"
                                alt="{{ auth()->user()->name }}">
            ...
            <div class="col-md-8">
                ...
                <div class="col-md-12 p-0">
                    ...
                    <x-input placeholder="{{ __('profile.profile.phone') }}" id="phone" name="phone" type="text" class="mt-1 block w-full" :value="old('phone', $user->phone)" required autofocus autocomplete="phone" />
