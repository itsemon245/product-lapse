...
@section('main')
    ...
    <section class="agency_about_area bg_color" id="tolink-2">
        <div class="container custom_container">
            <h2 class="f_size_30 f_600 t_color3 l_height40 text-center wow fadeInUp title-position" data-wow-delay="0.2s">
                About us</h2>
            <div class="row">
                <div class="col-md-6">
    ...
    <section class="agency_service_area" id="tolink-3">
        <div class="container custom_container">
            <h2 class="f_size_30 f_600 t_color3 l_height40 text-center mb_90 wow fadeInUp" data-wow-delay="0.2s">Features
            </h2>
            <div class="row mb_30">
                ...
                <div class="col-lg-3 col-6">
                    <div class="p_service_item agency_service_item wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <p>Efficiently plan your product and create an integrated action plan to ensure maximum efficiency
                ...
                <div class="col-lg-3 col-6">
                    <div class="p_service_item agency_service_item wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <p>Foster team collaboration and enhance communication to ensure seamless execution of projects and
                            ideas</p>
                ...
                <div class="col-lg-3 col-6">
                    <div class="p_service_item agency_service_item wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <p>Gain comprehensive insights into the performance of your products through detailed and customized
                            reports</p>
    ...
    <section class="pricing_area sec_pad" id="tolink-4">
        <div class="container custom_container p0">
            <div class="sec_title text-center">
                ...
                <p class="f_400 f_size_16 l_height30 mb-0 wow fadeInUp" data-wow-delay="0.2s">Different packages to suit
                                    ...
                                    <div class="card-header" id="heading25">
                                        <h5 class="mb-0">
                                            <button class="btn btn-link collapsed" data-toggle="collapse"
                                                ...
                                                Can i add more than one product at the same time ?<i class="ti-plus"></i><i
                                                    class="ti-minus"></i>
                                            </button>
                                        </h5>
                                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="action_content text-center">
                        <h2 class="f_600 f_size_30 l_height45 mb_40 wow fadeInUp" data-wow-delay="0.2s">Join now and enjoy
        ...
        <div class="container">
            <div class="row flex-row-reverse app_feature_info">
                <div class="col-xl-12 col-lg-12 text-center">
                    <h2 class=" f_size_30 f_700 t_color3 l_height45 mb-30 wow fadeInUp" data-wow-delay="0.2s">Contact us
                    </h2>
                </div>
